...
<main>
    ...
    <section>
        <div class="container mt-5">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="mb-4">Modifier un candidate</h2>
                    <?php
                    ...
                    if (!$result) {
                        echo "<p>Cet candidate n'existe pas.</p>";
                    } else {
                        ?>
                        <form action="update.php?id=<?php echo $result['CandidateID']; ?>" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="firstname">full name :</label>
                                <input type="text" name="full_name" id="firstname" class="form-control" value="<?php echo $result['full_name']; ?>" required>
                            </div>
                            <div class="form-group">
                                <label for="lastname">Email :</label>
                                <input type="email" name="Email" id="lastname" class="form-control" value="<?php echo $result['Email']; ?>" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="city" id="PhoneNumber" class="form-control" value="<?php echo $result['city']; ?>" required>
                            </div>
