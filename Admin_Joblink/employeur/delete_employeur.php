...
<main>
    ...
    <section>
        <div class="container mt-5">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="mb-4">Supprimer un employeur</h2>
                    <?php
                    ...
                    if (!$result) {
                        ...
                        ?>
                        <p>Voulez-vous vraiment supprimer employeur <?php echo $result['CompanyName']; ?> ?</p>
                        <form action="delete.php?id=<?php echo $result['EmployeurID']; ?>" method="post">
