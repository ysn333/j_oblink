...
$alertClass = isset($_GET['alert']) ? $_GET['alert'] : '';
                ...
                <div class="col-md-12">
                    ...
                    <div class="main">
                        <div class="aboutus col-lg-9 mx-auto">
                            <div class="img">
                                <div class="form-outl col-lg-12">
                                    <h3>mise à jour de l"emploi
                                    <?php
                                    ...
                                    <form action="includes/update_profile_image.php" enctype="multipart/form-data" method="post">
                                        <div class="upload">
                                            <div id="affishier-img">
                                                <img src="../uploads/profiles/default.png" id="image" style=" width: 159px;height: 104px;">
                                            </div>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <div class="aboutus col-lg-9 mx-auto mt-5">
                                <div class="img">
                                    <div class="form-outline col-lg-12">
                                        ...
                                        <form id="jobForm" action="Update_job_post.php" method="post">
                                            <input name="job_id" value="<?php echo $JobID;?> " style="display: none">
                                            <!-- First Section -->
                                            <div id="section1">
                                                <div class="col-md-12 mt-3">
                                                    <label>Job Title <span class="text-danger">*</span></label>
                                                    <input class="form-control" type="text" name="job_title" placeholder="Enter Job Title" required  value="<?php echo $job['JobTitle'];?>" >
                                                ...
                                                <div class="col-md-12 mt-3">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            $salaryValues = explode('-', str_replace('$', '', $salaryRange));
                                                            $minSalary = isset($salaryValues[0]) ? $salaryValues[0] : '';
                                                            ?>
                                                            <input class="form-control" type="number" name="min_salary" placeholder="Minimum Salary" value="<?php echo $minSalary; ?>">
                                                            <div class="invalid"></div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <?php
                                                            $maxSalary = isset($salaryValues[1]) ? $salaryValues[1] : '';
                                                            ?>
                                                            <input class="form-control" type="number" name="max_salary" placeholder="Maximum Salary" value="<?php echo $maxSalary; ?>">
                                                            <div class="invalid"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div id="section2" style="display: none;">
                                                <div class="col-md-12 mt-3">
                                                    ...
                                                    <textarea id="message" rows="2" class="block p-2.5 w-full max-w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="job_description" placeholder="Write your Cover letter here..." required><?php echo $job['JobDescription']; ?></textarea>
                                                    <div class="invalid"></div>
                                                </div>

                                                <div class="col-md-12 mt-3">
                                                    <label>Durée du contrat</label>
                                                    <input class="form-control" type="text" name="duree_contrat" value="<?php echo $job['duree_contrat'];?>" >
                                                    <div class="invalid"></div>
                                                </div>
                                                <div class="col-md-12 mt-3">
                                                    <label>Qualifications <span class="text-danger">*</span></label>
                                                    <input class="form-control" type="text" name="qualifications" placeholder="Enter Qualifications"  value="<?php echo $job['Qualifications'];?>"  required>
                                                    <div class="invalid"></div>
                                                </div>
                                                <div class="col-md-12 mt-3">
                                                    <label>Experience Required</label>
                                                    <input class="form-control" type="text" name="experience_required"  value="<?php echo $job['ExperienceRequired'];?>"  placeholder="Enter Experience">
                                                    <div class="invalid"></div>
                                                </div>
